...
plt.legend()
plt.tight_layout()
plt.savefig("model_improve/pm25_actual_vs_pred.png")   # บันทึกไฟล์
plt.show()
...
# save model
joblib.dump(model, "model_improve/pm25_model.pkl")
print("Saved model -> model_improve/pm25_model.pkl")
